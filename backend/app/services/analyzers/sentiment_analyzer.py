...
class SentimentAnalyzer:
    ...
    def _simple_analyze(self, text: str) -> Dict[str, any]:
        ...
        positive_words = {
            ...
            'wonderful', 'perfect', 'best', 'love', 'like', 'happy', 'positive',
            'success', 'successful', 'win', 'winner', 'profit', 'growth',
            'improve', 'improvement', 'better', 'strong', 'stable'
        }
        
        negative_words = {
            'bad', 'terrible', 'awful', 'horrible', 'worst', 'hate',
            'dislike', 'sad', 'negative', 'failure', 'fail', 'problem',
            'issue', 'error', 'crash', 'loss', 'decline', 'drop',
            'weak', 'poor', 'terrible', 'disappoint', 'disappointment'
        }
        
        neutral_words = {
            'company', 'release', 'announce', 'report', 'today',
            'yesterday', 'week', 'month', 'year', 'quarter', 'results'
        }
